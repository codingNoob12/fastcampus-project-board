...
values ('uno', 'asdf1234', 'Uno', 'uno@mail.com', 'I am Uno.', now(), 'uno',
        now(), 'uno')
;
insert into user_account (user_id, user_password, nickname, email, memo,
                          created_at, created_by, modified_at, modified_by)
values ('uno2', 'asdf1234', 'Uno2', 'uno2@mail.com', 'I am Uno2.', now(),
        'uno2', now(), 'uno2')
;

-- 123 게시글
insert into article (user_id, title, content, hashtag, created_by, modified_by,
...
-- 1000 댓글
insert into article_comment (article_id, user_id, content, created_at,
