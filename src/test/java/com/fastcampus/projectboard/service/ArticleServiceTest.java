...
class ArticleServiceTest {
    ...
    void givenNoSearchParameters_whenSearchingArticlesViaHashTag_thenReturnEmptyPage() {
        ...
        // When
        Page<ArticleDto> articles = sut.searchArticlesViaHashtag(null,
            pageable);
    ...
    void givenHashtag_whenSearchingArticlesViaHashTag_thenReturnArticlesPage() {
        ...
        // When
        Page<ArticleDto> articles = sut.searchArticlesViaHashtag(hashtag,
            pageable);
    ...
    @DisplayName("게시글을 ID로 검색하면, 댓글 달린 게시글을 반환한다.")
    @Test
    void givenArticleId_whenSearchingArticleWithComments_thenReturnArticleWithComments() {
        // Given
        long articleId = 1L;
    ...
    void givenModifiedArticleInfo_whenUpdatingArticle_thenUpdatesArticle() {
        ...
        given(articleRepository.getReferenceById(dto.id()))
            .willReturn(article);
        given(userAccountRepository.getReferenceById(dto.userAccountDto()
            .userId())).willReturn(dto.userAccountDto().toEntity());
    ...
    void givenArticleId_whenDeletingArticle_thenDeletesArticle() {
        ...
        willDoNothing().given(articleRepository)
            .deleteByIdAndUserAccount_UserId(articleId, userId);
