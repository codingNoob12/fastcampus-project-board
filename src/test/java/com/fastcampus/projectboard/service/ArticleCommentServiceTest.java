...
class ArticleCommentServiceTest {
    ...
    void givenArticleId_whenSearchingArticleComments_thenReturnsArticleComments() {
        ...
        // When
        List<ArticleCommentDto> articleComments = sut.searchArticleComments(
            articleId);
    ...
    @Test
    void givenNonexistentArticleComment_whenUpdatingArticleComment_thenLogsWaringAndDoesNothing() {
        // Given
        ArticleCommentDto dto = createArticleCommentDto("댓글");
        given(articleCommentRepository.getReferenceById(dto.id()))
            .willThrow(EntityNotFoundException.class);
